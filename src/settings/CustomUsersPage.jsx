...
const CustomUsersPage = () => {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      >
        <Card style={{ marginBottom: '20px', background: `linear-gradient(135deg, ${colors.primary}15, ${colors.secondary}15)` }}>
          <CardContent>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <div>
                <Typography variant="h4" style={{ color: colors.text, fontWeight: '600' }}>
                  {t('settingsUsers')}
                </Typography>
...
export default CustomUsersPage;
