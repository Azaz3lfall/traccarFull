...
const UnifiedTripsTab = ({
  ...
  return (
    <Box>
      ...
      {/* Tabs de filtro para viagens */}
      <Paper elevation={3} sx={{ p: 3 }}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 3 }}>
          <Tabs value={activeSubTab} onChange={handleSubTabChange}>
            <Tab label={`Em Aberto (${openTrips.length})`} />
            <Tab label={`Histórico (${closedTrips.length})`} />
          </Tabs>
        </Box>
...
export default UnifiedTripsTab;