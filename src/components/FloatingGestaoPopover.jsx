...
import { Typography, IconButton, Box, Tabs, Tab } from '@mui/material';
import { ChevronLeft as CloseIcon } from 'lucide-react';
import GestaoPageModular from '../other/gestao/GestaoPageModular';

const FloatingGestaoPopover = ({ 
  desktop, 
  isMenuExpanded,
  isDeviceListVisible,
  isVisible,
...
export default FloatingGestaoPopover;
