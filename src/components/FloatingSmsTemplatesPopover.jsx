...
import { SmsTemplatesContent } from '../settings/SmsTemplatesPage';

const FloatingSmsTemplatesPopover = ({
  desktop,
  isMenuExpanded,
  isVisible,
  onClose
...
export default FloatingSmsTemplatesPopover;
