              ...
              >
                ...
                >
                  <p style={{
                    ...
                    {t('sharedDeleteConfirm')} "{maintenanceToDelete?.name}"?
                  </p>
                  <div style={{
                    display: 'flex',
                    gap: '12px',
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontSize: '14px',
                        fontWeight: '500',
                        cursor: deleteMaintenanceMutation.isPending ? 'not-allowed' : 'pointer',
                        transition: 'all 0.2s',
                        opacity: deleteMaintenanceMutation.isPending ? 0.6 : 1
                      }}
                      onMouseEnter={(e) => {
